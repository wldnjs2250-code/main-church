    ...
    <div className="animate-in fade-in duration-500">
      ...
      <section className="bg-slate-900 py-24 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">하나님을 기쁘시게, 세상을 아름답게 하는 제자 공동체</p>
        </div>
      </section>
          ...
          <div className="bg-white p-12 md:p-20 rounded-[48px] border border-slate-100 shadow-sm relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-center gap-16 mb-20">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-3xl font-black mb-2 text-slate-900">담임목사 인사말</h3>
            ...
            <div className="space-y-12">
              <div className="p-10 bg-slate-50 rounded-[32px] border border-slate-100">
                 <h4 className="text-2xl font-black text-slate-900 mb-6">우리의 비전</h4>
